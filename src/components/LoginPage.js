    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
        ...
        <div className='flex flex-col justify-center'>
            <div className='max-w-[400px] w-full mx-auto p-8 px-8'>
                <img src={loginIcon} className='w-[72px] h-[72px] mb-8' alt=''/>
                ...
                <form className='pt-10 flex-initial'>
                    <div>
                        ...
                        <img src={emailIcon} className='w-4 h-4 translate-y-1/2 translate-x-1/2 absolute' alt=''/>
                        <input type='text' className='border-gray-300 border rounded-lg w-full h-8 mb-4 pl-8'/>
                    </div>
                    <div>
                        <label className='block'>Password </label>
                        <img src={passwordIcon} className='w-4 h-4 translate-y-1/2 translate-x-1/2 absolute' alt=''/>
